					...
					<form class="contact_form" action="settings" method="post">
						<div class="row">
							<label for="first_name" style="color: #0e1526">Enter your
								current password*:</label> <br /> <input class="input" name="password"
								type="password" value="" size="50" /><br /> <br />
						</div>
						<div class="row">
							<label for="first_name" style="color: #0e1526">Enter your
								new password*:</label> <br /> <input class="input" name="newPassword1"
								type="password" value="" size="50" /><br /> <br />
						</div>
						<div class="row">
							<label for="first_name" style="color: #0e1526">Repeat
								your new password*:</label> <br /> <input class="input"
								name="newPassword2" type="password" value="" size="50" /><br />
						</div>
						<%
						...
						%>
						<br /> <input class="submit_button" type="submit"
